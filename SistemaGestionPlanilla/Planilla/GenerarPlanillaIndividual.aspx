<%@ Page uiCulture="es" culture="es-PE" Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GenerarPlanillaIndividual.aspx.cs" Inherits="SistemaGestionPlanilla.Planilla.GenerarPlanillaIndividual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">Generar Planilla Construcción Civil
                                    </h3>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="m-input-icon">
                                                            <asp:TextBox runat="server" ID="txtDiasLaborados" style="text-align:center" CssClass="form-control m_touchspin_1"  Text="0" OnTextChanged="txtDiasLaborados_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="m-input-icon m-input-icon--right">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="m-input-icon">
                                                            <asp:TextBox runat="server" ID="txtDiasDomingosFeriados" Style="text-align: center" CssClass="form-control m_touchspin_1" Text="0" AutoPostBack="true" OnTextChanged="txtDiasDomingosFeriados_TextChanged"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="m-input-icon m-input-icon--right">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right">
                                                        <asp:TextBox runat="server" CssClass="form-control m-input param" placeholder="0.00" ID="txtAsignacionFamiliar" OnTextChanged="txtAsignacionFamiliar_TextChanged" AutoPostBack="true" ></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    <label class="">&nbsp;</label>
                                                    <div class="m-input-icon m-input-icon--right">
                                                        <asp:TextBox runat="server" CssClass="form-control m-input param" placeholder="0.00" ID="txtReintegros"  OnTextChanged="txtReintegros_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                    ...
                                                    <span class="m-form__help">Reintegros para el trabajador</span>
                                                </div>
                                                <div class="col-lg-12 nopadding-sides">
                                                    <label class="">&nbsp;</label>
                                                    <div class="m-input-icon m-input-icon--right">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        ...
                                                        <asp:TextBox runat="server" CssClass="form-control m-input param" placeholder="0.00" ID="txtHorasExtrasSimple" OnTextChanged="txtHorasExtrasSimple_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoHorasExtras60">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input param" placeholder="0.00" ID="txtHorasExtras60" OnTextChanged="txtHorasExtras60_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                                <i class="la la-clock-o"></i>
                                                            </span>
                                                    ...
                                                    <span class="m-form__help">Horas Extras 60%</span>
                                                </div>
                                                <div class="col-lg-12 nopadding-sides">
                                                    <label class="">&nbsp;</label>
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoHorasExtras100">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input param" placeholder="0.00" ID="txtHorasExtras100"  OnTextChanged="txtHorasExtras100_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                                <i class="la la-clock-o"></i>
                                                            </span>
                                                    ...
                                                    <span class="m-form__help">Horas Extras 100%</span>
                                                </div>                                      
                                            </div>
                                            <div class="col-lg-4">
                                                <label class="">&nbsp;</label>
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoBucTrabajador">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtBucTrabajador" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                    ...
                                                    <span class="m-form__help">BUC</span>
                                                </div>
                                                <div class="col-lg-12 nopadding-sides">
                                                    <label class="">&nbsp;</label>
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoPasajesTrabajador">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtPasajesTrabajador" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                                <i class="la la-bus"></i>
                                                            </span>
                                                    ...
                                                    <span class="m-form__help">Pasajes por dia laborado</span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        ...
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtVacacionalTrabajador"  AutoPostBack="true" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        ...
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtGratificacionTrabajador" AutoPostBack="true" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                                <i class="la la-money"></i>
                                                            </span>
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoLiquidacion">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtLiquidacionTrabajador"  AutoPostBack="true" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                    ...
                                                    <span class="m-form__help">Liquidacion</span>
                                                </div>                                                                                 
                                            </div>
                                            <div class="col-lg-4">
                                                <label class="">&nbsp;</label>
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        ...
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtBonifExtraEssaludTrabajador" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                                <i class="la la-money"></i>
                                                            </span>
                                                 ...
                                                 <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoBonifExtraPension">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtBonifExtraPensionTrabajador" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                                <i class="la la-money"></i>
                                                            </span>
                                                    ...
                                                    <span class="m-form__help">Bonificacion Extra Pension</span>
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoAporteComplementarioTrabajador">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtAporteComplementarioTrabajador"  AutoPostBack="true" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                                <i class="la la-bank"></i>
                                                            </span>
                                                    ...
                                                    <span class="m-form__help">Aporte Complementario</span>
                                                </div> 
                                                <div class="col-lg-12 nopadding-sides">
                                                    <label class="">&nbsp;</label>
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoConafovicerTrabajador">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtConafovicerTrabajador" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                    ...
                                                    <span class="m-form__help">Conafovicer</span>
                                                </div>
                                                 <div class="col-lg-12 nopadding-sides">
                                                    <label class="">&nbsp;</label>
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoAporteSindicalTrabajador">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtAporteSindicalTrabajador" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                    ...
                                                    <span class="m-form__help">Aporte Sindical</span>
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-12 nopadding-sides">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                                <asp:Label runat="server" ID="txtCalculoAporteComplementarioAFPTrabajador">0.00</asp:Label>
                                                            </span>
                                                        </div>
                                                        <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="0.00" ID="txtAporteComplementarioAFPTrabajador" AutoPostBack="true" ReadOnly="true"></asp:TextBox>
                                                        <span class="m-input-icon__icon m-input-icon__icon--right">
                                                            <span>
                                                                <i class="la la-bank"></i>
                                                            </span>
                                                    ...
                                                    <span class="m-form__help">Aportación Complementaria AFP</span>
                                                </div>  
										...
										<div class="m-invoice__head" style="background-image: url(/planilla/assets/images/bg-6.jpg);">
											<div class="m-invoice__container m-invoice__container--centered">
												<div class="m-invoice__logo">
													...
													<%--<a href="#">
														<img src="/assets/images/logo_client_white.png">
													</a>--%>
												</div>
												...
												<div class="m-invoice__items">
													<div class="m-invoice__item">
														...
														<span class="m-invoice__text"><asp:Label runat="server" style="text-transform:capitalize" ID="lblPeriodoBoleta"></asp:Label></span>
													</div>
													<div class="m-invoice__item">
														<span class="m-invoice__subtitle">SEMANA</span>
														<span class="m-invoice__text"><asp:Label runat="server" ID="lblSemanaBoleta"></asp:Label></span>
													</div>
													<div class="m-invoice__item">
														<span class="m-invoice__subtitle"><asp:Label runat="server" ID="lblCargoTrabajadorBoleta"></asp:Label></span>
														<span class="m-invoice__text"><asp:Label runat="server" ID="lblNombreTrabajadorBoleta"></asp:Label>
															<br><asp:Label runat="server" ID="lblDocumentoTrabajadorBoleta"></asp:Label></span>
													</div>
												</div>
											</div>
										</div>
												...
												<table class="table">
													...
													<tbody>
														<tr>
															...
															<td><asp:Label runat="server" ID="lblDiasLaboradosIngresos"></asp:Label></td>
															<td><asp:Label runat="server" ID="lblDiasDominicalIngresos"></asp:Label></td>
															<td>S/. <asp:Label runat="server" ID="lblTotalIngreso"></asp:Label></td>
														</tr>
														<tr>
															<td>Beneficios del Trabajador</td>
															<td><asp:Label runat="server" ID="lblDiasLaboradosBeneficios"></asp:Label></td>
															<td><asp:Label runat="server" ID="lblDiasDominicalBeneficios"></asp:Label></td>
															<td>S/. <asp:Label runat="server" ID="lblTotalBeneficios"></asp:Label></td>
														</tr>
														<tr>
															<td>Descuentos del Trabajador</td>
															<td><asp:Label runat="server" ID="lblDiasLaboradosDescuentos"></asp:Label></td>
															<td><asp:Label runat="server" ID="lblDiasDominicalDescuentos"></asp:Label></td>
															<td>S/. <asp:Label runat="server" ID="lblTotalDescuentos"></asp:Label></td>
														</tr>
                                                        <tr>
															<td>Aporte del Empleador</td>
															<td><asp:Label runat="server" ID="lblDiasLaboradosAporteEmp"></asp:Label></td>
															<td><asp:Label runat="server" ID="lblDiasDominicalAporteEmp"></asp:Label></td>
															<td>S/. <asp:Label runat="server" ID="lblTotalAporteEmp"></asp:Label></td>
														</tr>
													</tbody>
												</table>
											</div>
										...
										<div class="m-invoice__footer">
											<div class="m-invoice__container m-invoice__container--centered">
												<div class="m-invoice__content">
													...
													<span>
														<span>Banco:</span>
														<span><asp:Label runat="server" ID="lblNombreBancoBoleta"></asp:Label></span>
													</span>
													<span>
														<span>Número de cuenta:</span>
														<span><asp:Label runat="server" ID="lblNroCuentaBoleta"></asp:Label></span>
													</span>
													<span>
														<span>CCI:</span>
														<span><asp:Label runat="server" ID="lblNroCCIBoleta"></asp:Label></span>
													</span>
												</div>
												<div class="m-invoice__content">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:10px" >
                                        <div class="m-datable table-responsive">
                                            <asp:GridView runat="server" ID="dgvPlanillaRecientes" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered" RowStyle-BackColor="#FFFFFF" AlternatingRowStyle-BackColor="#F5F5F6" HeaderStyle-BackColor="#F5F5F6" HeaderStyle-Wrap="true" RowStyle-Wrap="true" ShowHeaderWhenEmpty="true" AllowPaging="True" PageSize="5" OnRowCommand="dgvPlanillaRecientes_RowCommand" OnPageIndexChanging="dgvPlanillaRecientes_PageIndexChanging">
                                                <Columns>
                                                    <asp:BoundField DataField="CodPlanillaConstruccion" HeaderText="CodPlanillaConstruccion" HtmlEncode="false" HeaderStyle-CssClass="hidden" Visible="false" ItemStyle-CssClass="hidden" />
                                                    ...
                                                    <asp:TemplateField HeaderText="OPCION" ItemStyle-Width="150">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lblDetalles" runat="server" CssClass="btn btn-sm btn-default"
                                                                ...
                                                                CommandArgument='<%# Eval("CodPlanillaConstruccion")%>'>
                                                            </asp:LinkButton>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#navSubMenuGenerarPlanillaIndividual').addClass("m-menu__item--active");
        })
