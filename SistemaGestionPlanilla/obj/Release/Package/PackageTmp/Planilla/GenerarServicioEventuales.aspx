<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GenerarServicioEventuales.aspx.cs" Inherits="SistemaGestionPlanilla.Planilla.GenerarServicioEventuales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="m-content">
                    <div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-dismissible m--margin-bottom-30" role="alert">
                        ...
                        <div class="m-alert__text">
                            Genere su recibo digital antes de guardar la el pago del servicio.
                        </div>
                    </div>
                    <div class="m-portlet m-portlet--mobile" id="gpFormularioPlanillaEventuales" runat="server">
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">Generar Servicio Eventuales
                                    </h3>
                                </div>
                            </div>
                                    ...
                                    <div id="gpFormularioTrabajador" runat="server">
                                        <div class="form-group m-form__group row" style="border-bottom: 1px dashed #ebedf2;">
                                            ...
                                            <div class="col-lg-6">
                                                <label>Oficio</label>
                                                <div class="m-input-icon m-input-icon--right">
                                                    <asp:DropDownList runat="server" CssClass="form-control m-select2 m-select2-general" ID="cboLaborTrabajo" Enabled="false" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                    <span class="m-input-icon__icon m-input-icon__icon--right">
                                                        <span>
                                                ...
                                                <span class="m-form__help">Oficio del trabajador.</span>
                                            </div>
                                        </div>
                                    ...
                                    <div id="gpFormularioParametros" runat="server">
                                        <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="m-input-icon m-input-icon--right">
                                                    <asp:DropDownList runat="server" CssClass="form-control m-select2 m-select2-general" ID="cboServicios" AutoPostBack="true" OnSelectedIndexChanged="cboServicios_SelectedIndexChanged" >
                                                    </asp:DropDownList>
                                                    <span class="m-input-icon__icon m-input-icon__icon--right">
                                                        <span>
                                                ...
                                                <span class="m-form__help">Seleccionar el servicio realizado.</span>
                                            </div>
                                            <div class="col-lg-6">
                                                <label class="">Unidad de medida</label>
                                                <div class="m-input-icon m-input-icon--right">
                                                    <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="Unidad de medida" ReadOnly="true" ID="txtUnidadMedida"></asp:TextBox>
                                                    <span class="m-input-icon__icon m-input-icon__icon--right">
                                                        <span>
                                                ...
                                                <span class="m-form__help">UM</span>
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row" style="border-bottom: 1px dashed #ebedf2;">
                                             <div class="col-lg-6">
                                                <label class="">Costo Unitario</label>
                                                <div class="m-input-icon m-input-icon--right">
                                                    <asp:TextBox runat="server" CssClass="form-control m-input" placeholder="Costo Unitario" ReadOnly="true" ID="txtCostoUnitario"></asp:TextBox>
                                                    <span class="m-input-icon__icon m-input-icon__icon--right">
                                                        <span>
                                                ...
                                                <span class="m-form__help">Costo Unitario</span>
                                            </div>
                                            <div class="col-lg-6">
                                                <label class="">Cantidad</label>
                                                <div class="m-input-icon m-input-icon--right">
                                                    <asp:TextBox runat="server" CssClass="form-control m-input param" placeholder="Cantidad" ID="txtCantidad"  OnTextChanged="txtCantidad_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                    <span class="m-input-icon__icon m-input-icon__icon--right">
                                                        <span>
                                                ...
                                                <span class="m-form__help">Cantidad</span>
                                            </div>
                                        </div>
                                                ...
                                                <div class="m-invoice__footer" style="margin-top: 0px;background-color:#fff">
                                                    <div class="m-invoice__container m-invoice__container--centered" style="padding: 30px 0 30px 0;">
                                                        <div class="m-invoice__content" style="text-align:right; padding-top: 20px;">
                                                            <h4 style="float:left;position:absolute">Total a Pagar</h4>
                                        ...
                                        <div class="m-form__actions m-form__actions--solid">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 m--align-right">
                                                    <asp:LinkButton CssClass="btn btn-primary" runat="server" ID="btnGenerarBoleta"  OnClick="btnGenerarBoleta_Click">Generar recibo</asp:LinkButton>
											...
											<div class="m-invoice__container m-invoice__container--centered">
												...
												<div class="m-invoice__items">
													<div class="m-invoice__item">
														<span class="m-invoice__subtitle">Nº RECIBO</span>
														<span class="m-invoice__text"><asp:Label runat="server" style="text-transform:capitalize" ID="lblNroBoleta"></asp:Label></span>
													</div>
													<div class="m-invoice__item">
													...
													<div class="m-invoice__item">
														<span class="m-invoice__subtitle"><asp:Label runat="server" ID="lblLaborTrabajadorBoleta"></asp:Label></span>
										...
										<div class="m-invoice__body m-invoice__body--centered">
											<div class="table-responsive">
												<table class="table">
													...
													<tbody>
														<tr>
															<td><asp:Label runat="server" ID="lblServicioRecibo"></asp:Label></td>
															<td><asp:Label runat="server" ID="lblUnidadMedidaRecibo"></asp:Label></td>
															<td><asp:Label runat="server" ID="lblPrecioUnitarioRecibo"></asp:Label></td>
                                                            <td><asp:Label runat="server" ID="lblCantidadRecibo"></asp:Label></td>
															<td>S/. <asp:Label runat="server" ID="lblTotalPagar"></asp:Label></td>
														</tr>
                                ...
                                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                                    <div class="m-form__actions m-form__actions--solid">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 m--align-right">                                                
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#gpGenerarPlanilla">Guardar Planilla Eventual</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="m-portlet__body"  runat="server">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:10px" >
                                        <div class="m-datable table-responsive">
                                            <asp:GridView runat="server" ID="dgvPlanillaRecientes" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered" RowStyle-BackColor="#FFFFFF" AlternatingRowStyle-BackColor="#F5F5F6" HeaderStyle-BackColor="#F5F5F6" HeaderStyle-Wrap="true" RowStyle-Wrap="true" ShowHeaderWhenEmpty="true" AllowPaging="True" PageSize="10" OnPageIndexChanging="dgvPlanillaRecientes_PageIndexChanging" OnRowCommand="dgvPlanillaRecientes_RowCommand" >
                                                <Columns>
                                                    <asp:BoundField DataField="CodPlanillaEventual" HeaderText="CodPlanillaConstruccion" HtmlEncode="false" HeaderStyle-CssClass="hidden" Visible="false" ItemStyle-CssClass="hidden" />
                                                    ...
                                                    <asp:BoundField DataField="DescripcionServicio" HeaderText="SERVICIO" HtmlEncode="false" />
                                                    <asp:BoundField DataField="UnidadMedida" HeaderText="UM" HtmlEncode="false" />
                                                    <asp:BoundField DataField="PrecioUnit" HeaderText="P. UNIT." HtmlEncode="false" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="header-center" />  
                                                    <asp:BoundField DataField="Cantidad" HeaderText="CANT." HtmlEncode="false" />
                                                    <asp:BoundField DataField="TotalPagar" HeaderText="TOTAL PAGAR" HtmlEncode="false" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="header-center" />                                                   
                                                    <asp:TemplateField HeaderText="OPCION" ItemStyle-Width="150">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lblDetalles" runat="server" CssClass="btn btn-sm btn-default"
                                                                ...
                                                                CommandArgument='<%# Eval("CodPlanillaEventual")%>'>
                                                            </asp:LinkButton>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <rsweb:ReportViewer ID="ReportViewer2" runat="server" font-names="Verdana" font-size="8pt" waitmessagefont-names="Verdana" waitmessagefont-size="14pt" backcolor="#F2F2F2" width="780px" height="700px" bordercolor="#2F4050" borderstyle="Solid" borderwidth="1px">
                                            <LocalReport ReportPath="Reportes\RViewer\ReciboCajaEventual.rdlc">
                                            <DataSources>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-weight: 400">¿Está seguro(a) que desea guardar el <strong>registro de planilla eventual</strong> del trabajador.</p>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#navSubMenuGenerarDestajo').addClass("m-menu__item--active");
        })
