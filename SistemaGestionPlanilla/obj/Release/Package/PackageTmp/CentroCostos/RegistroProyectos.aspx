<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RegistroProyectos.aspx.cs" Inherits="SistemaGestionPlanilla.CentroCostos.RegistroProyectos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="m-content">
                    <div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-dismissible m--margin-bottom-30" role="alert">
                        ...
                        <div class="m-alert__text">
                            Gestione los proyectos que se tomarán en cuenta para el cálculo de planilla.
                        </div>
                    </div>
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">Creación de proyectos
                                    </h3>
                                </div>
                            </div>
                            ...
                            <div class="m-form m-form--label-align-right  m--margin-bottom-30">
                                ...
                                <div class="row align-items-center" style="padding-top: 20px">
                                    <div class="col-xl-12 order-1 order-xl-2 m--align-left">
                                        <a runat="server" id="btnAgregarProyecto" onserverclick="btnAgregarProyecto_ServerClick"  style="color:#fff"  class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                            <span>
                                        ...
                                        <div class="m-portlet__body"  style="width:100%">
                                            <div id="gpFormularioPeriodo" runat="server">
                                                <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="lblNombreProyecto">Nombre Proyecto:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input"  placeholder="Ingrese el nombre del proyecto" ID="txtNombreProyecto" />
                                                        ...
                                                        <span class="m-form__help">Ingrese nombre proyecto.</span>
                                                    </div>
                                                     <div class="col-md-6">
                                                        <asp:Label runat="server" ID="lblPresupuesto">Presupuesto:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input presup"  placeholder="Ingrese el presupuesto" ID="txtPresupuesto" />
                                                            <span class="m-input-icon__icon m-input-icon__icon--right">
                                                                <span>
                                                        ...
                                                        <span class="m-form__help">Ingrese el presupesto.</span>
                                                    </div>
                                                ...
                                                <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input datepickers" placeholder="Ingrese fecha inicio" ID="txtFechaInicioProyecto" />
                                                            <span class="m-input-icon__icon m-input-icon__icon--right">
                                                                <span>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input datepickers" placeholder="Ingrese fecha fin" ID="txtFechaFinProyecto" />
                                                            <span class="m-input-icon__icon m-input-icon__icon--right">
                                                                <span>
                                                                    <i class="la la-calendar"></i>
                                                                </span>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#navSubMenuAgregarProyecto').addClass("m-menu__item--active");
        })
