<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RegistrarContratista.aspx.cs" Inherits="SistemaGestionPlanilla.Contratistas.RegistrarContratista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="m-content">
                    <div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-dismissible m--margin-bottom-30" role="alert">
                        ...
                        <div class="m-alert__text">
                            Gestione el registro y vigencia de los contratista.
                        </div>
                    </div>
                    <div class="m-portlet m-portlet--mobile" >
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">Registro de contratistas
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="m-portlet__body" id="gpConsultaContratistas" runat="server">
                            <!--begin: Search Form -->
                                            ...
                                            <div class="col-md-12">
                                                <div class="search-form">
                                                    <div class="input-group">
                                                        <asp:TextBox runat="server" ID="txtTextoBuscar" placeholder="Ingrese una parte del nombre del contratistas, dni o ruc" CssClass="form-control input-lg" MaxLength="200"></asp:TextBox>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left:0px">
                                <div class="m-datable table-responsive">
                                    <asp:GridView runat="server" ID="dgvContratistas" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered" RowStyle-BackColor="#FFFFFF" AlternatingRowStyle-BackColor="#F5F5F6" HeaderStyle-BackColor="#F5F5F6" HeaderStyle-Wrap="true" RowStyle-Wrap="true" ShowHeaderWhenEmpty="true" AllowPaging="True" PageSize="10" OnRowCommand="dgvContratistas_RowCommand" OnRowDataBound="dgvContratistas_RowDataBound" OnPageIndexChanging="dgvContratistas_PageIndexChanging"  >
                                        <Columns>
                                            <asp:BoundField DataField="CodProveedor" HeaderText="CodProyecto" HtmlEncode="false" HeaderStyle-CssClass="hidden" Visible="false" ItemStyle-CssClass="hidden" />
                                            ...
                                            <asp:BoundField DataField="FlagVigente" HeaderText="ESTADO" HtmlEncode="false" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="header-center" />
                        ...
                        <div class="m-portlet__body" id="gpFormularioContratista" runat="server" style="margin-top:-20px">
                                <!--begin: Search Form -->
                                <div class="m-form m-form--label-align-right  m--margin-bottom-30">
                                    <div class="row align-items-center">
                                        <div class="m-portlet__body"  style="width:100%">
                                            <div id="gpFormularioDatos" runat="server">
                                                <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="lblDescripcionContratista">Descripción Contratista:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input"  placeholder="Ingrese el nombre o razón social del contratista" ID="txtDescripcionContratista" />
                                                        ...
                                                        <span class="m-form__help">Ingrese descripción del contratista.</span>
                                                    </div>
                                                     <div class="col-md-6">
                                                        <asp:Label runat="server" ID="lblRuc">RUC:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input presup"  placeholder="Ingrese el RUC" ID="txtRuc" />
                                                            <span class="m-input-icon__icon m-input-icon__icon--right">
                                                                <span>
                                                ...
                                                <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="lblFechaInicio">Fecha Inicio Vigencia:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input datepickers" placeholder="Ingrese fecha inicio" ID="txtFechaInicioVigencia" />
                                                            <span class="m-input-icon__icon m-input-icon__icon--right">
                                                                <span>
                                                        ...
                                                        <span class="m-form__help">Ingrese fecha inicio de proyecto.</span>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="lblFechaFin">Fecha Fin Vigencia:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input datepickers" placeholder="Ingrese fecha fin" ID="txtFechaFinVigencia" />
                                                            <span class="m-input-icon__icon m-input-icon__icon--right">
                                                                <span>
                                                                    <i class="la la-calendar"></i>
                                                                </span>
                                                        ...
                                                        <span class="m-form__help">Ingrese fecha fin de proyecto.</span>
                                                    </div>
                                                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#navSubMenuAgregarContratistas').addClass("m-menu__item--active");
        })
