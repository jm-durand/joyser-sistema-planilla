<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ContratistasRegistroPagos.aspx.cs" Inherits="SistemaGestionPlanilla.Contratistas.ContratistasRegistroPagos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="m-content">
                    <div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-dismissible m--margin-bottom-30" role="alert">
                        ...
                        <div class="m-alert__text">
                            Gestione los pagos a contratistas que intervienen en su planilla.
                        </div>
                    </div>
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">Pago de Contratistas
                                    </h3>
                                </div>
                            </div>
                                        ...
                                        <div class="m-portlet__body"  style="width:100%">
                                            <div id="gpContratosContratista" runat="server">
                                                <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                    <div class="col-md-8">
                                                        <asp:Label runat="server" ID="lblContratistas">Contratistas:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:DropDownList runat="server" CssClass="form-control m-input" ID="cboContratistas"  OnSelectedIndexChanged="cboContratistas_SelectedIndexChanged" AutoPostBack="true" >
                                                            </asp:DropDownList>
                                                     ...
                                                     <div class="col-md-4">
                                                        <asp:Label runat="server" ID="lblPresupuesto">Filtro:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                             <asp:DropDownList runat="server" CssClass="form-control m-input" ID="cboFiltroPagos"  OnSelectedIndexChanged="cboFiltroPagos_SelectedIndexChanged" AutoPostBack="true" >
                                                        ...
                                                        <span class="m-form__help">Seleccione un filtro.</span>
                                                    </div>
                                               
                                                </div>
                                                <div id="gpListadoContratos" runat="server">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 0px">
                                                        <div class="m-datable table-responsive">
                                                            <asp:GridView runat="server" ID="dgvContratosContratista" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered" RowStyle-BackColor="#FFFFFF" AlternatingRowStyle-BackColor="#F5F5F6" HeaderStyle-BackColor="#F5F5F6" HeaderStyle-Wrap="true" RowStyle-Wrap="true" ShowHeaderWhenEmpty="true" AllowPaging="True" PageSize="5" OnRowDataBound="dgvContratosContratista_RowDataBound" OnRowCommand="dgvContratosContratista_RowCommand" OnPageIndexChanging="dgvContratosContratista_PageIndexChanging" >
                                                                <Columns>
                                                                    <asp:BoundField DataField="CodContrato" HeaderText="CodContrato" HtmlEncode="false" HeaderStyle-CssClass="hidden" Visible="false" ItemStyle-CssClass="hidden" />
                                                                    <asp:BoundField DataField="DescripcionTrabajoContrato" HeaderText="DESCRIPCIÓN" HtmlEncode="false" />
                                                                    <asp:BoundField DataField="DescripcionProveedor" HeaderText="CONTRATISTA" HtmlEncode="false" />
                                                                    ...
                                                                    <asp:BoundField DataField="EstadoPago" HeaderText="ESTADO" HtmlEncode="false" />                                                                                                                                        
                                                                    <asp:TemplateField HeaderText="OPCION">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lblPago" runat="server" CssClass="btn btn-sm btn-default" Visible='<%# Eval("EstadoPago").ToString() != "2" %>'
                                                                                Text='Generar Pago'
                                                ...
                                                <div id="gpListadoTrabajadores" runat="server" style="margin-top:20px">
                                                    <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                        <div class="col-md-12">
                                            ...
                                            <div id="gpFormularioPago" runat="server">
                                                <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="Label1">Contratista:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                             <asp:TextBox runat="server" CssClass="form-control m-input" ReadOnly="true" placeholder="Número de cheque" ID="txtContratistaDetalle" />
                                                            <span class="m-input-icon__icon m-input-icon__icon--right">
                                                                <span>
                                                        ...
                                                        <span class="m-form__help">Contratista.</span>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="Label2">Descripción Contrato:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:TextBox runat="server" CssClass="form-control m-input" ReadOnly="true" placeholder="Descripción Contrato" ID="txtDescripcionContrato" />
                                                            <span class="m-input-icon__icon m-input-icon__icon--right">
                                                                <span>
                                                        ...
                                                        <span class="m-form__help">Descripción Contrato.</span>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group m-form__group row" style="padding-bottom: 0; border-bottom: none">
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="lblTipoPago">Tipo Pago:</asp:Label>
                                                        <div class="m-input-icon m-input-icon--right">
                                                            <asp:DropDownList runat="server" CssClass="form-control m-input" ID="cboTipoPago" OnSelectedIndexChanged="cboTipoPago_SelectedIndexChanged" AutoPostBack="true" >
                                                                <asp:ListItem Text="Pago Total" Value="0" Selected="True"></asp:ListItem>
                                                                <asp:ListItem Text="Pago Parcial" Value="1"></asp:ListItem>
                                                        ...
                                                        <span class="m-form__help">Tipo de pago.</span>
                                                    </div>
                                                    <div class="col-md-6">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p style="font-weight: 400">¿Está seguro(a) que desea eliminar el <strong>registro de pago</strong> del contratista?</p>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#navSubMenuPagoContratistas').addClass("m-menu__item--active");
        })
        ...
        function AbriDetalles(event, id) {
            $.cookie("CodPagoContratistaDetalles", id);
            __doPostBack('<%=btnDetallesPagoContrato.UniqueID%>', '');
        }
        function EliminarPagoContratista(event, id) {
            $.cookie("CodPagoContratistaEliminar", id);
